...
import { Compass, Tent, TreesIcon as Tree } from "lucide-react"
...
const safaris = [
  {
    ...
    price: "From $1,200",
    img: "https://picsum.photos/seed/lion/1200/800",
  ...
  },
  {
    ...
    price: "From $950",
    img: "https://picsum.photos/seed/crater/1200/800",
  ...
  },
  {
    ...
    price: "From $450",
    img: "https://picsum.photos/seed/elephant-tar/1200/800",
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between mb-16 gap-6">
          <div className="max-w-2xl">
            ...
            <p className="text-muted-foreground">
              Witness the grandeur of the wild. From the endless plains of Serengeti to the depths of Ngorongoro, we offer luxury wildlife expeditions.
            </p>
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10">
          {safaris.map((safari, idx) => (
            <motion.div
              ...
              viewport={{ once: true }}
              className="group bg-background rounded-3xl overflow-hidden shadow-xl"
            >
